...
1. Import the Shortcut into the Shortcuts app on Mac using the `--open` argument or click `hello.shortcut` in Finder to open in Shortcuts
2. When prompted, click **Import**
