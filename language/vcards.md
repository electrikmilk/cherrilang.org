...
To use a local image file, use the output of the built-in [embedFile()](/language/standard/builtin#base64-encode-file) action to encode that file, then use it in a VCard using a variable reference.
